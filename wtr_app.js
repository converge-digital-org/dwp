...
return sessionId;
  ...
  function getExternalId() {
    ...
    let id = getCookie('dwp_external_id');
    if (!id) {
      id = generateRandomString(16);
      document.cookie = `dwp_external_id=${id}; path=/; max-age=${365 * 24 * 60 * 60}`;
    }
...
document.addEventListener('DOMContentLoaded', function () {
    extendCookiesWithBackup([
      ...
      { name: 'dwp_external_id', lifetimeInSeconds: 63115200 }
    ]);
  });
